...
Region, Ptol = 9.9999, idx = 1, name = "14Bus   14", slack = 1
...
Fault, bus = 4, tf = 1.0, tc = 1.3, rf = 0.0, xf = 0.001

Breaker, Vn = 69.0, bus = 2, fn = 60.0, idx = 1, line = "Line_4",
         name = "Breaker 1", t1 = 1.3, t2 = 200.0, u1 = 1, u2 = 1

PV, Vn = 69.0, bus = 2, busr = 2, idx = 2, name = "PV Bus 2",
    pg = 0.4, pmax = 1.0, pmin = 0.0, qmax = 0.5, qmin = -0.4,
    v0 = 1.045
PV, Vn = 69.0, bus = 3, busr = 3, idx = 3, name = "PV Bus 3",
    pmax = 1.0, pmin = 0.0, qmax = 0.4, v0 = 1.01
PV, Vn = 13.8, bus = 6, busr = 6, idx = 6, name = "PV Bus 6",
    pmax = 1.0, pmin = 0.0, qmax = 0.24, qmin = -0.06, v0 = 1.07
PV, Vn = 18.0, bus = 8, busr = 8, idx = 8, name = "PV Bus 8",
    pmax = 1.0, pmin = 0.0, qmax = 0.24, qmin = -0.06, v0 = 1.09

Shunt, Vn = 13.8, b = 0.19, bus = 9, idx = "Shunt_1", name = "Shunt Bus 9"

SW, Vn = 69.0, bus = 1, busr = 1, idx = 1, name = "SW Bus 1",
    pg = 2.324, pmax = 999.9, pmin = -999.9, qmax = 9.9, qmin = -9.9,
    v0 = 1.06
